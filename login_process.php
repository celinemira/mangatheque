...
$formPassword = $_POST['password_form'];
...
$stmt = $pdo->prepare('SELECT * FROM users WHERE email_form = :email_form');

$stmt->bindValue('email_form', $email);
$stmt->execute();
...
$passwordHash = $user['password_form'];

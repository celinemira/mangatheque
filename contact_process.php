...
// en base de données
$stmt = $pdo->prepare("INSERT INTO contact_requests (name_form, firstname_form, email_form, object_form, message_form) VALUES (:formName, :formFirstname, :formEmail, :formObject, :formMessage)");

// Lier les valeur à leurs paramètres
$stmt->bindValue('formName', $_POST['name_form']);
$stmt->bindValue('formFirstname', $_POST['firstname_form']);
$stmt->bindValue('formEmail', $_POST['email_form']);
$stmt->bindValue('formObject', $_POST['object_form'], PDO::PARAM_INT);
$stmt->bindValue('formMessage', $_POST['message_form']);
